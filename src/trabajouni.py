...
# from sympy import true  # Comentado porque no se necesita
...
def mostrar_catalogo():
    print("=== FUNCIÓN MOSTRAR CATÁLOGO EJECUTÁNDOSE ===")
    ...
    if tabla:
        ...
        print("No hay libros registrados en la sede " + sedeActual)
